...
const downloadJSON = (transfers) => {
  ...
  a.href = url;
  a.download = "transfers.json"; // File name
    ...
    <Box>
      ...
      >
        <Typography variant="h5" fontWeight="bold">
          Worldcoin Transaction: To {formatText(userAddress)}
        </Typography>
        <Typography variant="h5" fontWeight="bold">
            ...
            {currentTransfers.map((transfer, index) => {
              ...
              return (
                <TableRow key={transfer.transactionHash}>
                   ...
                   <TableCell sx={{color:"light.main"}}>{formatValue(transfer.value)}</TableCell>
      ...
      <Button
        ...
        >
<FileDownloadRoundedIcon />        </Button>    </Box>
    </Box>
  );
};

const DisplayToWorldCoinData = () => {
...
export default DisplayToWorldCoinData;
